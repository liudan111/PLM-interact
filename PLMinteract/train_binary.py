...
def add_args_func(parser):
    ...
    parser.add_argument('--task_name', type=str, default= "", help='Set the task name (e.g., binary)(default: "").')
    ...
    plminteract_parser.add_argument('--evaluation_steps', type=int, default=5000, help='Perform evaluation every N steps during training (default: 5000).')
    plminteract_parser.add_argument('--sub_samples',type=int,  default=128, help='Number of subsamples to use for evaluation (default: 128).') 
